    ...
    function (e) {
      ...
      function f(e) {
        return (
          ...
          ((e.delta >= 6 && o() - p < 60) ||
            (e.direction < 0 ? (t.isEnd && !t.params.loop) || t.animating || (t.slideNext(), i("scroll", e.raw)) : (t.isBeginning && !t.params.loop) || t.animating || (t.slidePrev(), i("scroll", e.raw)), (p = new n.Date().getTime()), !1))
        );
      }
      function g(e) {
        let s = e,
        ...
        setTranslate: () => {
          ...
          for (let r = 0; r < e.length; r += 1) {
            ...
            t.isHorizontal() ? s && (d = -d) : ((u = p), (p = 0), (c = -d), (d = 0)),
              t.browser && t.browser.isSafari && ((Math.abs(d) / 90) % 2 == 1 && (d += 0.001), (Math.abs(c) / 90) % 2 == 1 && (c += 0.001)),
          ...
          setTranslate: () => {
            ...
            for (let e = 0, s = a.length; e < s; e += 1) {
              ...
              Math.abs(w) < 0.001 && (w = 0),
                ...
                t.browser && t.browser.isSafari && ((Math.abs(m) / 90) % 2 == 1 && (m += 0.001), (Math.abs(h) / 90) % 2 == 1 && (h += 0.001));
